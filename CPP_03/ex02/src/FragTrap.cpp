...
/*   Updated: 2025/05/05 14:45:34 by aschenk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const unsigned int	FragTrap::_DEFAULT_ATTACK_DAMAGE	= 30;
...
FragTrap::FragTrap(const FragTrap& other) : ClapTrap(other) { // Delegate copy oeprator to ClapTrap
	std::cout << "🐣 " << BLUE << _name << RESET << ": " << GREEN << "FragTrap" << RESET 
